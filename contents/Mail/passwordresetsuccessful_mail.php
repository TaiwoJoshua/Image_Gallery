...
$mail->msgHTML(file_get_contents('password_reset_successful_content.php'), __DIR__); //Read an HTML message body from an external file, convert referenced images to embedded,
